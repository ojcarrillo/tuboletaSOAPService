...
public class TuBoletaService extends Service {
    ...
    public final static QName SERVICE = new QName("http://www.example.org/demo/", "TuBoletaService");
    public final static QName TuBoletaServicesEndpoint = new QName("http://www.example.org/demo/", "TuBoletaServicesEndpoint");
    static {
        URL url = null;
        try {
